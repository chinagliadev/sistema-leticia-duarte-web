    ...
    <div class="pessoaAutorizada" id="autorizada-2">
        ...
        <div class="fields">
            ...
            <div class="three wide field" id="div_telefone_autorizada2">
                ...
                <input type="text" name="txtTelefoneAutorizada2" id="txtTelefoneAutorizada2" placeholder="">
    ...
    <div class="pessoaAutorizada" id="autorizada-3">
        ...
        <div class="fields">
            ...
            <div class="three wide field" id="div_telefone_autorizada3">
                ...
                <input type="text" name="txtTelefoneAutorizada3" id="txtTelefoneAutorizada3" placeholder="">
                <div class="ui hidden negative message" id="mensagem-erro-telefone3-autorizada">
                    <div class="content">
                        <i class="user icon"></i><span id="telefone-autorizada3-erro"></span>
                    </div>
                </div>
            </div>
            <div class="four wide field" id="div_parentesco3">
                ...
                <div class="ui hidden negative message" id="mensagem-erro-parentesco-autorizada3">
                    <div class="content">
                        <i class="user icon"></i><span id="parentesco-autorizada-erro3"></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="pessoaAutorizada" id="autorizada-4">
        ...
        <div class="fields">
            ...
            <div class="four wide field" id="div_parentesco4">
                ...
                <div class="ui hidden negative message" id="mensagem-erro-parentesco-autorizada4">
                    <div class="content">
                        <i class="user icon"></i><span id="parentesco-autorizada-erro4"></span>
                    </div>
                </div>
            </div>
        </div>
