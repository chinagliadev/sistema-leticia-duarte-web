    ...
    <div class="responsavel" id="responsavel-1">
        ...
        <div class="fields">
            ...
            <div class="four wide field" id="salario_responsavel_div">
                ...
                <input type="text" id="txtSalario_1" name="txtSalario_1" placeholder="R$1500,00..." value="<?= $responsavel_1['salario'] ?? '' ?>">
            </div>
    ...
    <div class="responsavel_2 <?= !empty($responsavel_2['nome']) ? '' : 'oculto' ?>" id="responsavel_2">
        ...
        <div class="fields">
            ...
            <div class="eight wide field" id="nome_responsavel_div_2">
                ...
                <input type="text" id="txtNomeResponsavel_2" name="txtNomeResponsavel_2" 
                       value="<?= $responsavel_2['nome'] ?? '' ?>">
            </div>
            ...
            <div class="four wide field" id="data_nascimento_responsavel_2_div">
                ...
                <div class="ui calendar" id="dataNascimentoCalendar_2">
                    <div class="ui input">
                        <input type="text" id="txtDataNascimento_2" value="<?= $responsavel_2['data_nascimento'] ?? '' ?>" placeholder="dd/mm/aaaa">
                    </div>
                </div>
        ...
        <div class="fields">
            ...
            <div class="four wide field" id="telefone_responsavel_2_div">
                ...
                <input type="text" id="txtTelefone_2" name="txtTelefone_2" placeholder="(19) 99999-9999" value="<?= $responsavel_2['celular'] ?? '' ?>">
            </div>

            <div class="six wide field" id="email_responsavel_2_div">
                <label for="txtEmail_2">Email</label>
                <input type="email" id="txtEmail_2" name="txtEmail_2" placeholder="exemplo@email.com" value="<?= $responsavel_2['email'] ?? '' ?>">
            </div>
        </div>
        ...
        <div class="fields">
            ...
            <div class="four wide field" id="salario_responsavel_2_div">
                ...
                <input type="text" id="txtSalario_2" name="txtSalario_2" placeholder="R$1500,00..." value="<?= $responsavel_2['salario'] ?? '' ?>">
            </div>
