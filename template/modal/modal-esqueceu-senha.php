  ...
  (function() {
    ...
    btnNext.addEventListener('click', function() {
      if (currentStep === 1) {
        ...
        const errosSenha = validarSintaxeEsqueceuSenha(n);
        if (errosSenha.length > 0) {
          mostrarErro(msgErroNova, "Senha inválida:<br>• " + errosSenha.join("<br>• "));
          Swal.fire({
            icon: 'warning',
            title: 'Atenção',
            html: 'Corrija os erros da senha antes de continuar.<br><br>' +
              "• " + errosSenha.join("<br>• "),
            confirmButtonText: 'OK',
            confirmButtonColor: '#1C86CC'
          });
